      ...
      <Box className={styles.container}>
        <Box className={styles.pageHeader}>
          <Typography className={styles.pageTitle}>
            {requestData
              ? 'ดูรายละเอียดการเปิดรายวิชา (ระดับปริญญาโท)'
              : 'แบบเปิดรายวิชาประจำภาคการศึกษา (ระดับปริญญาโท)'}
          </Typography>
          ...
          <Typography className={styles.pageDescription}>
            {requestData
              ...
              : 'หน้าสำหรับบันทึกคำขอเปิดรายวิชาในสาขา ระดับปริญญาโท โดยยึดโครงหน้าหลักจากปริญญาตรีและเปลี่ยนเฉพาะข้อมูลที่แตกต่าง'}
          </Typography>
        </Box>
