...
function CourseOpeningBachelorPage() {
  ...
  const handleChangeYearBlockField = (blockId, fieldName, value) => {
    setYearBlocks((prev) =>
      prev.map((block) =>
        block.id === blockId ? { ...block, [fieldName]: value } : block
      )
    )
  }
  ...
  const handleAddResponsiblePerson = () => {
    setApprovalForm((prev) => ({
      ...
      responsiblePeople: [
        ...
        { id: Date.now() + Math.random(), name: '', signedDate: '' },
      ],
    }))
  }
      ...
      <Box className={styles.container}>
        <Box className={styles.pageHeader}>
          <Typography className={styles.pageTitle}>
            {requestData
              ? 'ดูรายละเอียดการเปิดรายวิชา (ระดับปริญญาตรี)'
              : 'แบบเปิดรายวิชาประจำภาคการศึกษา (ระดับปริญญาตรี)'}
          </Typography>
          ...
          <Typography className={styles.pageDescription}>
            {requestData
              ...
              : 'หน้าสำหรับบันทึกคำขอเปิดรายวิชาในสาขา ระดับปริญญาตรี ตอนนี้เป็นการม็อคหน้าจอและ flow การกรอกข้อมูลก่อนเชื่อม API จริง'}
          </Typography>
        </Box>
            ...
            <Box className={styles.modeCardTop}>
              <Box className={styles.modeTextBlock}>
                ...
                <Typography className={styles.modeTitle}>
                  {generalForm.curriculumName} • สาขา {generalForm.majorName}
                </Typography>
            ...
            <Box className={styles.optionRowTwo}>
              ...
              <Box className={styles.optionGroup}>
                  ...
                  {targetGroupOptions.map((item) => {
                    ...
                    return (
                      <FormControlLabel
                        ...
                        control={<Radio />}
                        label={item.label}
                        disabled={isFormDisabled || !isAllowed}
                      />
                    )
                  })}
                </RadioGroup>
                ...
                <Typography className={styles.helperText}>
                  {studyForm.campus === 'chakrabongse'
                    ? 'เมื่อเลือกจักรพงษภูวนารถ จะเลือกได้เฉพาะ ส.อ.บ.'
                    : 'เมื่อเลือกบางพระ จะเลือกได้เฉพาะ BP หรือ Five Plus'}
                </Typography>
              </Box>
            </Box>
          </Box>
              ...
              <Box key={block.id} className={styles.yearBlock}>
                <Box className={styles.yearBlockHeader}>
                  <Box className={styles.yearBlockHeaderLeft}>
                    <Box className={styles.yearBadge}>
                      ชั้นปีที่ {block.yearLevel}
                    </Box>
                ...
                <Box className={styles.tableSection}>
                  <Box className={styles.tableHeaderRow}>
                    <Box className={`${styles.tableHeaderCell} ${styles.colIndex}`}>
                      #
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colCode}`}>
                      รหัสวิชา
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colName}`}>
                      ชื่อรายวิชา
                    </Box>
                    <Box
                      className={`${styles.tableHeaderCell} ${styles.colCredits}`}
                    >
                      จำนวนหน่วยกิต
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colGroup}`}>
                      กลุ่ม
                    </Box>
                    <Box
                      className={`${styles.tableHeaderCell} ${styles.colStudents}`}
                    >
                      จำนวนนักศึกษา(จริง)
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colTrack}`}>
                      รายวิชา (สายวิทยาศาสตร์)
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colTrack}`}>
                      รายวิชา (มนุษยศาสตร์และสังคมศาสตร์)
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colNote}`}>
                      หมายเหตุ
                    </Box>
                    <Box className={`${styles.tableHeaderCell} ${styles.colAction}`}>
                      จัดการ
                    </Box>
                  </Box>
                  ...
                  <Box className={styles.tableBody}>
                    {block.subjectRows.map((row, rowIndex) => (
                      ...
                      >
                        ...
                        <Box
                          className={`${styles.tableCell} ${styles.colCredits}`}
                        >
                          <TextField
                            value={row.credits}
                            onChange={(event) =>
                        ...
                        <Box
                          className={`${styles.tableCell} ${styles.colStudents}`}
                        >
                          <TextField
                ...
                <Box className={styles.subjectActionRow}>
                  ...
                  <Typography className={styles.rowCount}>
                    {block.subjectRows.length} รายวิชา
                  </Typography>
                </Box>
              </Box>
            ))}
